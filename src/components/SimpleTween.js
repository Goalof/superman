	...
	render() {
		return <div className="container">
			<div className="row">
				...
				<div className="col-12 mt-3">
					<img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/16327/logo-man.svg" alt="" className="img-fluid logo" ref={img => this.logoContainer = img} />
				</div>
			</div>
		</div>;
	}
